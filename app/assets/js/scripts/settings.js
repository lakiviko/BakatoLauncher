...
function processLogOut(val, isLastAccount){
    ...
    if(targetAcc.type === 'microsoft') {
        ...
        AuthManager.removePlainAccount(uuid)
...
const settingsCurrentPlainAccounts = document.getElementById('settingsCurrentPlainAccounts')
...
function populateAuthAccounts(){
    ...
    settingsCurrentPlainAccounts.innerHTML = plainAuthAccountStr
}
...
function populateReleaseNotes(){
    $.ajax({
        url: 'https://github.com/lakiviko/BakatoLauncher/releases.atom',
        success: (data) => {
